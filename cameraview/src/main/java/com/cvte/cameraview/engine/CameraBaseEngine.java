...
import com.cvte.cameraview.picture.PictureRecorder;
...
import com.cvte.cameraview.video.VideoRecorder;
...
public abstract class CameraBaseEngine extends CameraEngine {
    ...
    protected final Size computeFrameProcessingSize() {
        ...
        if (maxWidth <= 0 || maxWidth == Integer.MAX_VALUE) maxWidth = 1080;
        if (maxHeight <= 0 || maxHeight == Integer.MAX_VALUE) maxHeight = 1920;
