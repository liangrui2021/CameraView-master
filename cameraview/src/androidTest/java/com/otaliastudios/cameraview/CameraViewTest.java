...
import com.cvte.cameraview.markers.DefaultAutoFocusMarker;
...
public class CameraViewTest extends BaseTest {
    ...
    public void testOverlays_generateLayoutParams() {
        ...
        View overlay = inflater.inflate(com.cvte.cameraview.test.R.layout.overlay, cameraView, false);
    ...
    public void testOverlays_dontGenerateLayoutParams() {
        cameraView.mOverlayLayout = spy(cameraView.mOverlayLayout);
        LayoutInflater inflater = LayoutInflater.from(getContext());
        View overlay = inflater.inflate(com.cvte.cameraview.test.R.layout.not_overlay, cameraView, false);
