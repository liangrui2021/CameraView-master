...
import com.cvte.cameraview.CameraListener
import com.cvte.cameraview.CameraOptions
import com.cvte.cameraview.CameraView
import com.cvte.cameraview.gesture.GestureAction
import com.cvte.cameraview.overlay.OverlayLayout
...
abstract class Option<T: Any>(val name: String) {
    ...
    abstract class Control<T: com.cvte.cameraview.controls.Control>(private val kclass: KClass<T>, name: String) : Option<T>(name) {
    ...
    class Mode : Control<com.cvte.cameraview.controls.Mode>(com.cvte.cameraview.controls.Mode::class, "Mode")

    class Engine : Control<com.cvte.cameraview.controls.Engine>(com.cvte.cameraview.controls.Engine::class, "Engine") {
        override fun set(view: CameraView, value: com.cvte.cameraview.controls.Engine) {
            if (view.isOpened) {
    ...
    class Preview : Control<com.cvte.cameraview.controls.Preview>(com.cvte.cameraview.controls.Preview::class, "Preview Surface") {
        override fun set(view: CameraView, value: com.cvte.cameraview.controls.Preview) {
            if (view.isOpened) {
                view.addCameraListener(object : CameraListener() {
                    override fun onCameraClosed() {
                        super.onCameraClosed()
        ...
        private fun applyPreview(view: CameraView, value: com.cvte.cameraview.controls.Preview) {
    ...
    class Flash : Control<com.cvte.cameraview.controls.Flash>(com.cvte.cameraview.controls.Flash::class, "Flash")

    class WhiteBalance : Control<com.cvte.cameraview.controls.WhiteBalance>(com.cvte.cameraview.controls.WhiteBalance::class, "White Balance")

    class Hdr : Control<com.cvte.cameraview.controls.Hdr>(com.cvte.cameraview.controls.Hdr::class, "HDR")
    ...
    class VideoCodec : Control<com.cvte.cameraview.controls.VideoCodec>(com.cvte.cameraview.controls.VideoCodec::class, "Video Codec")

    class AudioCodec : Control<com.cvte.cameraview.controls.AudioCodec>(com.cvte.cameraview.controls.AudioCodec::class, "Audio Codec")

    class Audio : Control<com.cvte.cameraview.controls.Audio>(com.cvte.cameraview.controls.Audio::class, "Audio")

    abstract class Gesture(val gesture: com.cvte.cameraview.gesture.Gesture, name: String) : Option<GestureAction>(name) {
    ...
    class Pinch : Gesture(com.cvte.cameraview.gesture.Gesture.PINCH, "Pinch")

    class HorizontalScroll : Gesture(com.cvte.cameraview.gesture.Gesture.SCROLL_HORIZONTAL, "Horizontal Scroll")

    class VerticalScroll : Gesture(com.cvte.cameraview.gesture.Gesture.SCROLL_VERTICAL, "Vertical Scroll")

    class Tap : Gesture(com.cvte.cameraview.gesture.Gesture.TAP, "Tap")

    class LongTap : Gesture(com.cvte.cameraview.gesture.Gesture.LONG_TAP, "Long Tap")

    abstract class Overlay(private val overlay: View, private val target: com.cvte.cameraview.overlay.Overlay.Target, name: String) : Option<Boolean>(name) {
        override fun getAll(view: CameraView, options: CameraOptions) = listOf(true, false)
        override fun get(view: CameraView): Boolean {
            val params = overlay.layoutParams as OverlayLayout.LayoutParams
            return when (target) {
                com.cvte.cameraview.overlay.Overlay.Target.PREVIEW -> params.drawOnPreview
                com.cvte.cameraview.overlay.Overlay.Target.PICTURE_SNAPSHOT -> params.drawOnPictureSnapshot
                com.cvte.cameraview.overlay.Overlay.Target.VIDEO_SNAPSHOT -> params.drawOnVideoSnapshot
            }
        }
        ...
        override fun set(view: CameraView, value: Boolean) {
            val params = overlay.layoutParams as OverlayLayout.LayoutParams
            when (target) {
                com.cvte.cameraview.overlay.Overlay.Target.PREVIEW -> params.drawOnPreview = value
                com.cvte.cameraview.overlay.Overlay.Target.PICTURE_SNAPSHOT -> params.drawOnPictureSnapshot = value
                com.cvte.cameraview.overlay.Overlay.Target.VIDEO_SNAPSHOT -> params.drawOnVideoSnapshot = value
            }
            overlay.layoutParams = params
        }
    }

    class OverlayInPreview(overlay: View) : Overlay(overlay, com.cvte.cameraview.overlay.Overlay.Target.PREVIEW, "Overlay in Preview")

    class OverlayInPictureSnapshot(overlay: View) : Overlay(overlay, com.cvte.cameraview.overlay.Overlay.Target.PICTURE_SNAPSHOT, "Overlay in Picture Snapshot")

    class OverlayInVideoSnapshot(overlay: View) : Overlay(overlay, com.cvte.cameraview.overlay.Overlay.Target.VIDEO_SNAPSHOT, "Overlay in Video Snapshot")

    class Grid : Control<com.cvte.cameraview.controls.Grid>(com.cvte.cameraview.controls.Grid::class, "Grid Lines")
    ...
    class PictureFormat : Control<com.cvte.cameraview.controls.PictureFormat>(com.cvte.cameraview.controls.PictureFormat::class, "Picture Format")
